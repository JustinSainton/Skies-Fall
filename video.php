	...
	<body class="video">
		...
		<div id="panel-1" class="panel">
			<div class="panel-container">
				...
				<img class="play-button" src="/dev/img/play.png" alt="Play Video" />
			</div>
		</div>
		...
		<div id="panel-2" class="panel">
			<div class="panel-container">
				...
				<ul id="portfolio">
					...
					<li>
						<a href=""><img src="/dev/img/client-logos/united-way.png" alt="United Way" /></a>
					</li>
					<li>
						<a href=""><img src="/dev/img/client-logos/atlantic.png" alt="Atlantic Records" /></a>
					</li>
					<li>
						<a href=""><img src="/dev/img/client-logos/mtv.png" alt="MTV" /></a>
					</li>
					<li>
						<a href=""><img src="/dev/img/client-logos/dillards.png" alt="Dillard's" /></a>
					</li>
					<li>
						<a href=""><img src="/dev/img/client-logos/qvc.png" alt="QVC" /></a>
					</li>
					<li>
						<a href=""><img src="/dev/img/client-logos/hbo.png" alt="HBO" /></a>
					</li>
					<li>
						<a href=""><img src="/dev/img/client-logos/skillet.png" alt="Skillet" /></a>
					</li>
					<li>
						<a href=""><img src="/dev/img/client-logos/reach.png" alt="Reach Records" /></a>
					</li>
					<li>
