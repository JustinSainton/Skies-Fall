...
jQuery( document ).ready( function( $ ) {
	...
	var size_design_scrollers = function() {
		...
		$( 'div.print div.scroll-space' ).css( 'height', Math.round( window.innerWidth * 0.43645833333333334 ) );
		...
		var screenImage = $( 'div.print img' ).eq(0), theImage = new Image(), theImage.src = screenImage.attr( 'src' );
